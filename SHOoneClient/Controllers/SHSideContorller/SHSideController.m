...
@interface SHSideController()<UIGestureRecognizerDelegate>
{
...
@implementation SHSideController
...
- (void)setRootViewController:(UIViewController *)rootViewController animated:(BOOL)animated
{
    ...
    [UIView animateWithDuration:0.2 animations:^{
        ...
        CGAffineTransform tranform = CGAffineTransformMakeTranslation(offset, 0.0f);
            strongSelf.rootContentView.transform = CGAffineTransformScale(tranform,0.8,0.8);
...
- (void)showLeftViewController:(BOOL)animated
{
    ...
    [UIView animateWithDuration:animatedTime animations:^{
        ...
        strongSelf.rootContentView.transform = CGAffineTransformScale(transform,scale,scale);
...
- (void)panGestureRecognizer:(UIPanGestureRecognizer*)panGestureRecognizer
{
    ...
    if (xOffSet != _rootContentView.frame.origin.x)
    {
        ...
        self.rootContentView.transform = CGAffineTransformScale(transform,scale,scale);
    }
