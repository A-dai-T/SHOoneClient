...
+ (instancetype)shared
{
    ...
    static SHNavigationController *sharedinstance = nil;
    dispatch_once(&pred, ^{
        // 使用storyBoard初始化控制器
        sharedinstance = [[self alloc] init];
        UIStoryboard *storyBoard = [UIStoryboard storyboardWithName:@"Main" bundle:nil];
        sharedinstance = [storyBoard instantiateViewControllerWithIdentifier:@"SHOoneController"];
    });
...
- (void)viewDidLoad
{
    ...
    NSString *imageName = iOS7 ? @"nav_bg_large_image":@"nav_bg_image";
